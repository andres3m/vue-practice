<template>
  <!-- <h1 v-bind:style="miColor"> or <h1 :style="miColor"> for red text-->
  <h1 :class="selector">
    Hola me llamo {{ miNombre }} y tendre {{ miEdad+1 }}
  </h1>
